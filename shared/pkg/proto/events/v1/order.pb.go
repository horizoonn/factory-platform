...
func (x *OrderPaid) GetOccurredAt() *timestamppb.Timestamp {
	if x != nil {
		return x.OccurredAt
	}
	return nil
...
func (x *ShipAssembled) GetOccurredAt() *timestamppb.Timestamp {
	if x != nil {
		return x.OccurredAt
	}
	return nil
...
const file_events_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x15events/v1/order.proto\x12\tevents.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf5\x01\n" +
	"\tOrderPaid\x12\x1d\n" +
	"\n" +
