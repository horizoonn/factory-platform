...
func (r *Repository) MarkPublished(ctx context.Context, workerID string, eventID uuid.UUID) error {
	const query = `
		UPDATE platform.assembly_outbox_events
...
func (r *Repository) Reschedule(
	...
	return r.execLeaseUpdate(ctx, query, eventID, workerID, nextAttemptAt, lastError)
}
...
func (r *Repository) MarkFailed(
	...
	return r.execLeaseUpdate(ctx, query, eventID, workerID, lastError)
}
